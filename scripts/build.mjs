...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/png" href="${typeof brandIcon !== "undefined" ? brandIcon : BRAND_ICON_DATA_URI}" />
    <link rel="shortcut icon" href="${typeof brandIcon !== "undefined" ? brandIcon : BRAND_ICON_DATA_URI}" />
    <link rel="apple-touch-icon" href="${typeof brandIcon !== "undefined" ? brandIcon : BRAND_ICON_DATA_URI}" />
  ...
  <body>
    <div class="container">
      <nav>
        <img class="logo-mark" src="${typeof brandIcon !== "undefined" ? brandIcon : BRAND_ICON_DATA_URI}" alt="BiteRight logo" />
        <span>BiteRight</span>
      </nav>
      <main>
      <h1>${heading}</h1>
