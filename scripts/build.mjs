  ...
  <body>
    ...
    <div class="container">
      <nav>
        ...
        <a href="${APP_STORE_URL}" class="btn btn-primary">Download on the App Store</a>
      </nav>
      ...
      <div class="analysis-grid">
        ...
        <aside>
          <section class="glass-card app-promo">
            ...
            <p>${ctaBody}</p>
            <a href="${APP_STORE_URL}" class="btn btn-primary">Scan in BiteRight</a>
          </section>
    ...
    <div class="sticky-cta">
      <a href="${APP_STORE_URL}" class="btn btn-primary"><i data-feather="download-cloud"></i> Get the Gluten Scanner</a>
    </div>
